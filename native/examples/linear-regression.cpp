...
int main() {
    ...
    Plaintext pt_age;
    Ciphertext ct_age;
    batch_encoder.encode(data->age, pt_age);
    encryptor.encrypt(pt_age, ct_age);
    Plaintext pt_income;
    Ciphertext ct_income;
    batch_encoder.encode(data->income, pt_income);
    encryptor.encrypt(pt_income, ct_income);
